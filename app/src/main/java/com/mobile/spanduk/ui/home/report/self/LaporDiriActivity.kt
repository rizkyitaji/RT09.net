package com.mobile.spanduk.ui.home.report.self
...
import com.mobile.spanduk.databinding.ActivityLaporDiriBinding
...
class LaporDiriActivity : AppCompatActivity() {
    ...
    private lateinit var bind: ActivityLaporDiriBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        bind = ActivityLaporDiriBinding.inflate(layoutInflater)
        ...
        if (net.isOnline()) {
            mDatabase = ref.orderByChild("type").equalTo("Lapor Diri")
            ...
            mDatabase.addValueEventListener(object : ValueEventListener {
                ...
                override fun onCancelled(error: DatabaseError) {
                    Toast.makeText(this@LaporDiriActivity, ""+error.message, Toast.LENGTH_SHORT).show()
                }
            })
